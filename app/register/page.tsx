...
if (
  ...
  setError("Diese E-Mail ist schon registriert. Ich bringe dich zum Login…");
  setLoading(false);
  setTimeout(() => {
    router.push(`/login?email=${encodeURIComponent(emailTrim)}`);
    router.refresh();
  }, 700);
  return;
}
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  background: loading ? "rgba(0,0,0,0.06)" : "rgba(255,255,255,0.78)",
